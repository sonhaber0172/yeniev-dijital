      ...
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-5">
          <a
            ...
            className="w-10 h-10 rounded-full glass flex items-center justify-center text-[#A78BFA] hover:text-white hover:border-[#7B5CF0] transition-all"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-full glass flex items-center justify-center text-[#25D366] hover:text-white hover:border-[#25D366] transition-all"
            aria-label="WhatsApp"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-xs text-[#9B9BB4]">
          © {new Date().getFullYear()} YeniEv Dijital. Tüm hakları saklıdır.
        </p>
      </div>
    </footer>
  );
